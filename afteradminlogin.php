...
<i class="fa fa-reorder" onclick="callsh()" style="cursor:pointer;font-size:24px;margin:20px 2px 0px 20px;color:white"></i>
		...
		<img src="admin1.png" style="border-radius:15%;margin-left:25%;float:left" width="70px" height="80px">
				<h3  style="float:left;cursor:pointer;margin:10px 2px 0px 20px;"><b>CS | Admin<b></h3>
